...
Source0:        http://downloads.sourceforge.net/openturns-modules/otsliced/otsliced-%{version}.tar.bz2
BuildRequires:  gcc-c++, cmake, swig
BuildRequires:  openturns-devel
BuildRequires:  python3-openturns
BuildRequires:  python3-devel
Requires:       libotsliced0

%description
Template module for OpenTURNS library.

%package -n libotsliced0
Summary:        otsliced development files
Group:          Development/Libraries/C and C++

%description -n libotsliced0
Dynamic libraries for otsliced.

%package devel
Summary:        otsliced development files
Group:          Development/Libraries/C and C++
Requires:       libotsliced0 = %{version}
Requires:       openturns-devel

%description devel
Development files for otsliced library.

%package -n python3-%{name}
Summary:        otsliced library
Group:          Productivity/Scientific/Math
Requires:       python3-openturns
%description -n python3-%{name}
Python textual interface to otsliced uncertainty library
...
%post -n libotsliced0 -p /sbin/ldconfig 
%postun -n libotsliced0 -p /sbin/ldconfig 

%files -n libotsliced0
%defattr(-,root,root,-)
%{_libdir}/*.so.*
